...
const getData=()=>{
    fetch("https://8080-fbfcecabdfeffcbcfcaeccfaecbcfbbaf.examlyiopb.examly.io/courses/getAll").then((response)=>{
    ...
    const saveCourses =()=>{
        ...
        axios.post('https://8080-fbfcecabdfeffcbcfcaeccfaecbcfbbaf.examlyiopb.examly.io/courses/savecourses',values).then((res)=>{
    ...
    {
      fetch("https://8080-fbfcecabdfeffcbcfcaeccfaecbcfbbaf.examlyiopb.examly.io/courses/"+id,{
        method: "DELETE",
      }).then(()=>{
...
<div className='addBox' id={display.visible}>
    ...
    <TextField id="filled-basic" label="Courses Name" variant="filled" onChange={(e) => { handleFormInputs('coursesname', e.target.value) }} /><br></br>
    <br/><br/>
    <TextField id="filled-basic" label="Courses Description" variant="filled" onChange={(e) => { handleFormInputs('coursesDescription', e.target.value) }} /><br></br>
    <br/><br/>
    <TextField id="filled-basic" label="Courses Duration" variant="filled" onChange={(e) => { handleFormInputs('coursesDuration', e.target.value) }} /><br></br>
    <br/><br/>
   {/* <TextField id="filled-basic" label="Institute Name" variant="filled" onChange={(e) => { handleFormInputs('institutename', e.target.value) }} /><br></br>
    ...
    <Autocomplete
                    ...
                    renderInput={(params) => <TextField {...params} label="institute Names" variant="filled" />}
                />
                <br></br>
